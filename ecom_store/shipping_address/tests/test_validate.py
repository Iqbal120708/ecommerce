...
class TestAddress(APITestCase):
    ...
    def test_validate_model(self, mock_logger):
        ...
        with self.assertRaises(ValidationError) as ctx:
            ...
            self.assertEqual(ctx["city"][0], "The selected city does not belong to the specified province.")
            self.assertEqual(ctx["district"][0], "The selected district does not belong to the specified city.")
            self.assertEqual(ctx["subdistrict"][0], "The selected subdistrict does not belong to the specified district.")
