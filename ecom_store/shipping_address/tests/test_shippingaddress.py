...
class TestAddress(TransactionTestCase):
    ...
    def setUp(self):
        ...
        self.shipping_address.users.add(self.user, self.user2)
        ...
        self.shipping_address2.users.add(self.user2)
    ...
    def test_get_with_user1(self, mock_logger):
        ...
        self.assertEqual(data["users"][0]["email"], "test@gmail.com")
        
        self.assertEqual(data["users"][1]["id"], 2)
        self.assertEqual(data["users"][1]["username"], "test2")
        self.assertEqual(data["users"][1]["email"], "test2@gmail.com")
    ...
    def test_get_with_user2(self, mock_logger):
        ...
        self.assertEqual(data2["street_address"], "Jl. Test 2")
        ...
        self.assertEqual(data2["users"][0]["id"], 2)
        self.assertEqual(data2["users"][0]["username"], "test2")
        self.assertEqual(data2["users"][0]["email"], "test2@gmail.com")
    ...
    def test_post_new_data(self, mock_logger):
        ...
        # data ada 3, 2 dari setup, 1 dari post
        shipping_address = ShippingAddress.objects.all()
        self.assertEqual(len(shipping_address), 3)
